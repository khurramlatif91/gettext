...
/* ./.libs/lt-ngettext.c - temporary wrapper executable for .libs/ngettext.exe
   Generated by libtool (GNU libtool) 2.4.6

   The ngettext program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "C:\\workspace\\gettext-0.19.8\\gettext-runtime\\intl\\.libs;C:\\pgBuild32\\lib;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "C:\\pgBuild32\\lib;C:\\pgBuild32\\bin;C:\\workspace\\gettext-0.19.8\\gettext-runtime\\intl\\.libs;";
const char * TARGET_PROGRAM_NAME = "ngettext.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# ngettext - temporary wrapper script for .libs/ngettext.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The ngettext program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' ../intl/libintl.la /c/pgBuild32/lib/libiconv.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"ngettext.exe:ngettext:$LINENO: libtool wrapper (GNU libtool) 2.4.6\" 1", f);
  fputs (">&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"ngettext.exe:ngettext:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"ngettext.exe:ngettext:$LINENO: newargv[0]: $progdir/$program\" 1>", f);
  fputs ("&2\n", f);
  ...
  fputs ("    PATH=/c/pgBuild32/lib:/c/pgBuild32/bin:/c/workspace/gettext-0.19.8/gettext-", f);
  fputs ("runtime/intl/.libs:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/c/workspace/gettext-0.19.8/gettext-runtime/intl/.libs:/c/pgBuild32/l", f);
  fputs ("ib:$PATH\"\n", f);
  fputs ("\n", f);
