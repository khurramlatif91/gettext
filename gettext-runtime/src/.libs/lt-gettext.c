...
/* ./.libs/lt-gettext.c - temporary wrapper executable for .libs/gettext.exe
...
const char * TARGET_PROGRAM_NAME = "gettext.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# gettext - temporary wrapper script for .libs/gettext.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The gettext program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"gettext.exe:gettext:$LINENO: libtool wrapper (GNU libtool) 2.4.6\" 1>&", f);
  fputs ("2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"gettext.exe:gettext:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"gettext.exe:gettext:$LINENO: newargv[0]: $progdir/$program\" 1>&2\n", f);
